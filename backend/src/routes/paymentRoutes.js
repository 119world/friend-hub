...
import { createOrder, createSubscription, submitManualPayment, verifyPayment } from "../controllers/paymentController.js";
...
router.post("/manual-submit", requireUser, asyncHandler(submitManualPayment));
