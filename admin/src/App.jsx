  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Guard><AdminLayout /></Guard>}>
        ...
        <Route path="payments" element={<ResourcePage title="Payments" endpoint="/admin/payments" fields={["user_id", "amount", "currency", "status", "order_id", "payment_id", "cf_order_id", "created_at", "updated_at"]} />} />
        <Route path="plans" element={<ResourcePage title="Recharge Plans" endpoint="/admin/plans" fields={["id", "title", "originalPrice", "price", "diamonds", "minutes", "subscription", "autoPay", "autoPayAmount", "renewEveryDays", "totalCycles", "active"]} />} />
        ...
        <Route path="partner-accounts" element={<ResourcePage title="Partner Accounts" endpoint="/admin/partnerAccounts" fields={["id", "partnerId", "loginId", "password", "displayName", "phone", "role", "active"]} />} />
